    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const LoadingSkeletonWidget(width: 100, height: 24, borderRadius: 6),
          const SizedBox(height: 8),
          const LoadingSkeletonWidget(width: 70, height: 11, borderRadius: 4),
        ],
      ),
    );
  }
...
class SkeletonActivityItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          const LoadingSkeletonWidget(width: 40, height: 40, borderRadius: 10),
          ...
          const SizedBox(width: 12),
          const LoadingSkeletonWidget(width: 50, height: 11, borderRadius: 4),
        ],
      ),
    );
  }
